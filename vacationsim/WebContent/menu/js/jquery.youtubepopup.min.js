...
(function(h, g) {
	...
	var d = {
		init : function(i) {
			...
			if (b == null) {
				...
				b.dialog({
					...
					create : function() {
						f.backgroundImage = h(".ui-dialog").css(
								"background-image");
						f.border = h(".ui-dialog").css("border");
						f.backgroundColor = h(".ui-dialog").css(
								"background-color")
					},
					close : function() {
						b.html("");
					...
					h(k).bind(
							...
							function() {
								...
								var n = g.location.protocol
										+ "//www.youtube.com/embed/" + o
										+ "?rel=0&showsearch=0&autohide="
										+ i.autohide;
								n += "&autoplay=" + i.autoplay + "&controls="
										+ i.controls + "&fs=" + i.fs + "&loop="
										+ i.loop;
								n += "&showinfo=" + i.showinfo + "&color="
										+ i.color + "&theme=" + i.theme;
								...
								b.dialog("open");
								h(".ui-widget-overlay").fadeTo("fast",
										i.overlayOpacity);
								...
								l.removeClass("ui-corner-all").addClass(
										"ui-corner-top");
								if (!i.showBorder) {
									h(".ui-dialog").css({
		...
		close : function() {
			b.html("");
			h(".ui-dialog-titlebar").hide();
			
			b.dialog("close");
		}		
	};
	function e(j, l, i) {
		var k = '<iframe title="YouTube video player" style="margin:0; padding:0;" width="'
				+ l + '" ';
		k += 'height="' + i + '" src="' + j
